...
function updateStateData(state) {
    ...
    if (statename === "state") {
        ...
        index = stateData.statename.indexOf(state);
    }
    if (index !== -1) {
        document.getElementById("statename").textContent = stateData.statename[index];
        document.getElementById("nickname").textContent = stateData.nn[index];
        document.getElementById("established").textContent = stateData.estab[index];
        document.getElementById("motto").textContent = stateData.mott[index];
        document.getElementById("demonym").textContent = stateData.dem[index];
        document.getElementById("capital").textContent = stateData.capitAL[index];
        document.getElementById("largestCity").textContent = stateData.large[index];
        document.getElementById("postalAbbr").textContent = stateData.postalAbbr[index];
        document.getElementById("traditionalAbbr").textContent = stateData.tradAbbr[index];
        document.getElementById("numCounties").textContent = stateData.countiesCount[index];
        document.getElementById("stateBird").textContent = stateData.burd[index];
        document.getElementById("stateTree").textContent = stateData.treEs[index];
        document.getElementById("stateFlower").textContent = stateData.flower[index];
    } else {console.log("state not found in data")};
}
